 ...
 * Version 1.1.7
 * 
 * https://github.com/trevorpowell/Backbone.sessionStorage
...
(function (root, factory) {
  if (typeof exports === 'object' && typeof require === 'function') {
    ...
    define(["backbone"], function(Backbone) {
      // Use global variables if the sessions are undefined.
...
extend(Backbone.SessionStorage.prototype, {
  ...
  findAll: function() {
    ...
    for (var i = 0, id, data; i < this.records.length; i++) {
      ...
      data = this.jsonData(this.sessionStorage().getItem(this.name+"-"+id));
...
// window.Store.sync and Backbone.sessionSync is deprecated, use Backbone.SessionStorage.sync instead
